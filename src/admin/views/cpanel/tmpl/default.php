    ...
    <div id="cpanel">
        <?php for ($i = 0; $i < count($this->views); $i++) :
            ...
            <div style="float:left;">
                <div class="icon">
                    <a id="link_<?php echo strtolower($view['name']); ?>"
                       href="<?php echo $link; ?>" <?php echo $class . " " . $rel; ?>>
                        <img src='components/com_ostoolbar/assets/images/<?php echo $view['icon']; ?>'
                             alt='<?php echo $view['name']; ?>'/>
