...
class JFormFieldLanguage extends JFormField
{
    ...
    protected function getInput()
    {
        ...
        foreach ($languages as $language) {
            ...
            $sys_plg_sys_lang_file                 = JPath::clean(
        ...
        <div>
            <select name="language_code" id="language_code" onchange="ChangeLanguage()">
                <?php foreach ($languages as $language): ?>
                    <option value="<?php echo($language->element); ?>" <?php if ($default_lang == $language->element) {
                        echo('selected="selected"');
                    } ?> ><?php echo($language->name); ?></option>
                <?php endforeach; ?>
            </select>
            <button onclick="SaveLanguage(); return false;" id="btn_apply_lang" style="float:left"><?php echo(JText::_(
                    "Update"
                )); ?></button>
        ...
        <div style="position:relative;">
            <div class="tab_item"><label for="sys_COM_OSTOOLBAR"><?php echo(JText::_(
                        "CONFIG_COM_OSTOOLBAR"
                    )); ?></label><input type="text" name="sys_language" id="COM_OSTOOLBAR"
                                         value="<?php echo($translates[$language->element]["sys"]["COM_OSTOOLBAR"]); ?>"/>
            </div>
            <div class="tab_item"><label for="plg_PLG_QUICKICON_OSTOOLBAR"><?php echo(JText::_(
                        "CONFIG_PLG_QUICKICON_OSTOOLBAR"
                    )); ?></label><input type="text" name="plg_language" id="PLG_QUICKICON_OSTOOLBAR"
                                         value="<?php echo($translates[$language->element]["plg"]["PLG_QUICKICON_OSTOOLBAR"]); ?>"/>
            </div>
        </div>
        <script>
