...
class plgSystemOsToolbar extends JPlugin
{
	...
	function onAfterDispatch()
	{
		...
		$doc->addStyleDeclaration(".icon-32-tutorial{background:url('".JURI::root()."administrator/components/com_ostoolbar/assets/images/icon-tutorials-small.png');width:46px !important;}
